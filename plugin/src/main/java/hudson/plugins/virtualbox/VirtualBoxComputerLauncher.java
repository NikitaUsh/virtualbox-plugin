...
public class VirtualBoxComputerLauncher extends ComputerLauncher {
    ...
    public VirtualBoxComputerLauncher(
            ComputerLauncher delegate,
            String hostName,
    ...
    public void launch(SlaveComputer computer, TaskListener listener) throws IOException, InterruptedException {
        ...
        try {
            ...
            long result = VirtualBoxUtils.startVm(
                    machine, virtualMachineType, new VirtualBoxTaskListenerLog(listener, "[VirtualBox] "));
            if (result != 0) {
     ...
     */
    private boolean delegateLaunch(SlaveComputer computer, TaskListener listener) {
        try {
    ...
    public void afterDisconnect(SlaveComputer computer, TaskListener listener) {
        ...
        try {
            ...
            long result = VirtualBoxUtils.stopVm(
                    machine, virtualMachineStopMode, new VirtualBoxTaskListenerLog(listener, "[VirtualBox] "));
            if (result != 0) {
